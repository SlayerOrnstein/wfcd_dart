...
mixin BlueprintLocationMappable {
  ...
  @override
  String toString() {
    return BlueprintLocationMapper.ensureInitialized().stringifyValue(
      this as BlueprintLocation,
    );
  }
  ...
  bool operator ==(Object other) {
    return BlueprintLocationMapper.ensureInitialized().equalsValue(
      this as BlueprintLocation,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return BlueprintLocationMapper.ensureInitialized().hashValue(
      this as BlueprintLocation,
    );
  }
}
...
extension BlueprintLocationValueCopy<$R, $Out>
  ...
  get $asBlueprintLocation => $base.as(
    (v, t, t2) => _BlueprintLocationCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class BlueprintLocationCopyWith<
  $R,
  $In extends BlueprintLocation,
  $Out
>
  ...
  ListCopyWith<
    ...
    BlueprintLocationEnemyCopyWith<
      $R,
      BlueprintLocationEnemy,
      BlueprintLocationEnemy
    >
...
class BlueprintLocationEnemyMapper
  ...
  static const Field<BlueprintLocationEnemy, String> _f$name = Field(
    'name',
    _$name,
  );
  static double _$dropChance(BlueprintLocationEnemy v) => v.dropChance;
  static const Field<BlueprintLocationEnemy, double> _f$dropChance = Field(
    'dropChance',
    _$dropChance,
  );
  static String? _$rarity(BlueprintLocationEnemy v) => v.rarity;
  static const Field<BlueprintLocationEnemy, String> _f$rarity = Field(
    'rarity',
    _$rarity,
  );
  static double? _$chance(BlueprintLocationEnemy v) => v.chance;
  static const Field<BlueprintLocationEnemy, double> _f$chance = Field(
    'chance',
    _$chance,
  );
...
mixin BlueprintLocationEnemyMappable {
  ...
  >
  get copyWith =>
      _BlueprintLocationEnemyCopyWithImpl<
        BlueprintLocationEnemy,
        BlueprintLocationEnemy
      >(this as BlueprintLocationEnemy, $identity, $identity);
  @override
  String toString() {
    return BlueprintLocationEnemyMapper.ensureInitialized().stringifyValue(
  ...
  @override
  bool operator ==(Object other) {
    return BlueprintLocationEnemyMapper.ensureInitialized().equalsValue(
      this as BlueprintLocationEnemy,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return BlueprintLocationEnemyMapper.ensureInitialized().hashValue(
      this as BlueprintLocationEnemy,
    );
  }
}
...
extension BlueprintLocationEnemyValueCopy<$R, $Out>
  ...
  get $asBlueprintLocationEnemy => $base.as(
    (v, t, t2) => _BlueprintLocationEnemyCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
