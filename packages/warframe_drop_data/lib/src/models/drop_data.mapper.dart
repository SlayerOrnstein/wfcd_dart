...
class DropDataMapper extends ClassMapperBase<DropData> {
  ...
  static const Field<DropData, List<BountyReward>> _f$bountyRewards =
      Field('bountyRewards', _$bountyRewards);
...
mixin DropDataMappable {
  String toJson() {
    return DropDataMapper.ensureInitialized()
        .encodeJson<DropData>(this as DropData);
  }

  Map<String, dynamic> toMap() {
    return DropDataMapper.ensureInitialized()
        .encodeMap<DropData>(this as DropData);
  }

  DropDataCopyWith<DropData, DropData, DropData> get copyWith =>
      _DropDataCopyWithImpl<DropData, DropData>(
          this as DropData, $identity, $identity);
  @override
  String toString() {
  ...
  bool operator ==(Object other) {
    return DropDataMapper.ensureInitialized()
        .equalsValue(this as DropData, other);
  }
...
abstract class DropDataCopyWith<$R, $In extends DropData, $Out>
  ...
  ListCopyWith<$R, BlueprintLocation,
          BlueprintLocationCopyWith<$R, BlueprintLocation, BlueprintLocation>>
      get blueprintLocations;
  ListCopyWith<$R, BountyReward,
      BountyRewardCopyWith<$R, BountyReward, BountyReward>> get bountyRewards;
  $R call(
...
class _DropDataCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<$R, BlueprintLocation,
          BlueprintLocationCopyWith<$R, BlueprintLocation, BlueprintLocation>>
      get blueprintLocations => ListCopyWith($value.blueprintLocations,
          (v, t) => v.copyWith.$chain(t), (v) => call(blueprintLocations: v));
  @override
  ListCopyWith<$R, BountyReward,
          BountyRewardCopyWith<$R, BountyReward, BountyReward>>
      get bountyRewards => ListCopyWith($value.bountyRewards,
          (v, t) => v.copyWith.$chain(t), (v) => call(bountyRewards: v));
  @override
  $R call(
          {List<BlueprintLocation>? blueprintLocations,
          List<BountyReward>? bountyRewards}) =>
  ...
  DropData $make(CopyWithData data) => DropData(
      blueprintLocations:
          data.get(#blueprintLocations, or: $value.blueprintLocations),
