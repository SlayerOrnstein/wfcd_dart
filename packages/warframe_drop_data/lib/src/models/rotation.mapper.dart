...
class RotationsMapper extends ClassMapperBase<Rotations> {
  ...
  static const Field<Rotations, List<RotationReward>> _f$a = Field('a', _$a, key: r'A', opt: true, def: const []);
  static List<RotationReward> _$b(Rotations v) => v.b;
  static const Field<Rotations, List<RotationReward>> _f$b = Field('b', _$b, key: r'B', opt: true, def: const []);
  static List<RotationReward> _$c(Rotations v) => v.c;
  static const Field<Rotations, List<RotationReward>> _f$c = Field('c', _$c, key: r'C', opt: true, def: const []);
...
mixin RotationsMappable {
  String toJson() {
    return RotationsMapper.ensureInitialized().encodeJson<Rotations>(this as Rotations);
  }

  Map<String, dynamic> toMap() {
    return RotationsMapper.ensureInitialized().encodeMap<Rotations>(this as Rotations);
  }

  RotationsCopyWith<Rotations, Rotations, Rotations> get copyWith =>
      _RotationsCopyWithImpl<Rotations, Rotations>(this as Rotations, $identity, $identity);
  @override
  String toString() {
    return RotationsMapper.ensureInitialized().stringifyValue(this as Rotations);
  }

  @override
  bool operator ==(Object other) {
    return RotationsMapper.ensureInitialized().equalsValue(this as Rotations, other);
  }
...
abstract class RotationsCopyWith<$R, $In extends Rotations, $Out> implements ClassCopyWith<$R, $In, $Out> {
  ListCopyWith<$R, RotationReward, RotationRewardCopyWith<$R, RotationReward, RotationReward>> get a;
  ListCopyWith<$R, RotationReward, RotationRewardCopyWith<$R, RotationReward, RotationReward>> get b;
  ListCopyWith<$R, RotationReward, RotationRewardCopyWith<$R, RotationReward, RotationReward>> get c;
  $R call({List<RotationReward>? a, List<RotationReward>? b, List<RotationReward>? c});
  RotationsCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _RotationsCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Rotations, $Out>
    implements RotationsCopyWith<$R, Rotations, $Out> {
  _RotationsCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<Rotations> $mapper = RotationsMapper.ensureInitialized();
  @override
  ListCopyWith<$R, RotationReward, RotationRewardCopyWith<$R, RotationReward, RotationReward>> get a =>
  ...
  @override
  $R call({List<RotationReward>? a, List<RotationReward>? b, List<RotationReward>? c}) =>
      $apply(FieldCopyWithData({if (a != null) #a: a, if (b != null) #b: b, if (c != null) #c: c}));
  @override
  ...
  @override
  RotationsCopyWith<$R2, Rotations, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
...
class RotationRewardMapper extends ClassMapperBase<RotationReward> {
  ...
  static const Field<RotationReward, String> _f$rarity = Field('rarity', _$rarity);
  static double? _$chance(RotationReward v) => v.chance;
  static const Field<RotationReward, double> _f$chance = Field('chance', _$chance);
...
mixin RotationRewardMappable {
  String toJson() {
    return RotationRewardMapper.ensureInitialized().encodeJson<RotationReward>(this as RotationReward);
  }

  Map<String, dynamic> toMap() {
    return RotationRewardMapper.ensureInitialized().encodeMap<RotationReward>(this as RotationReward);
  }

  RotationRewardCopyWith<RotationReward, RotationReward, RotationReward> get copyWith =>
      _RotationRewardCopyWithImpl<RotationReward, RotationReward>(this as RotationReward, $identity, $identity);
  @override
  String toString() {
    return RotationRewardMapper.ensureInitialized().stringifyValue(this as RotationReward);
  }

  @override
  bool operator ==(Object other) {
    return RotationRewardMapper.ensureInitialized().equalsValue(this as RotationReward, other);
  }

  @override
  int get hashCode {
    return RotationRewardMapper.ensureInitialized().hashValue(this as RotationReward);
  }
}

extension RotationRewardValueCopy<$R, $Out> on ObjectCopyWith<$R, RotationReward, $Out> {
  RotationRewardCopyWith<$R, RotationReward, $Out> get $asRotationReward =>
      $base.as((v, t, t2) => _RotationRewardCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class RotationRewardCopyWith<$R, $In extends RotationReward, $Out> implements ClassCopyWith<$R, $In, $Out> {
  $R call({String? id, String? name, String? rarity, double? chance, String? stage});
  RotationRewardCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _RotationRewardCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, RotationReward, $Out>
    implements RotationRewardCopyWith<$R, RotationReward, $Out> {
  _RotationRewardCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<RotationReward> $mapper = RotationRewardMapper.ensureInitialized();
  @override
  $R call({String? id, String? name, Object? rarity = $none, Object? chance = $none, Object? stage = $none}) => $apply(
    FieldCopyWithData({
      if (id != null) #id: id,
  ...
  @override
  RotationRewardCopyWith<$R2, RotationReward, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
