...
class RotationsMapper extends ClassMapperBase<Rotations> {
  ...
  static const Field<Rotations, List<RotationReward>> _f$a =
      Field('a', _$a, key: r'A', opt: true, def: const []);
  static List<RotationReward> _$b(Rotations v) => v.b;
  static const Field<Rotations, List<RotationReward>> _f$b =
      Field('b', _$b, key: r'B', opt: true, def: const []);
  static List<RotationReward> _$c(Rotations v) => v.c;
  static const Field<Rotations, List<RotationReward>> _f$c =
      Field('c', _$c, key: r'C', opt: true, def: const []);

  @override
  final MappableFields<Rotations> fields = const {
    #a: _f$a,
    #b: _f$b,
    #c: _f$c,
  };
...
mixin RotationsMappable {
  String toJson() {
    return RotationsMapper.ensureInitialized()
        .encodeJson<Rotations>(this as Rotations);
  }

  Map<String, dynamic> toMap() {
    return RotationsMapper.ensureInitialized()
        .encodeMap<Rotations>(this as Rotations);
  }

  RotationsCopyWith<Rotations, Rotations, Rotations> get copyWith =>
      _RotationsCopyWithImpl<Rotations, Rotations>(
          this as Rotations, $identity, $identity);
  @override
  String toString() {
    return RotationsMapper.ensureInitialized()
        .stringifyValue(this as Rotations);
  }

  @override
  bool operator ==(Object other) {
    return RotationsMapper.ensureInitialized()
        .equalsValue(this as Rotations, other);
  }
...
abstract class RotationsCopyWith<$R, $In extends Rotations, $Out>
  ...
  ListCopyWith<$R, RotationReward,
      RotationRewardCopyWith<$R, RotationReward, RotationReward>> get a;
  ListCopyWith<$R, RotationReward,
      RotationRewardCopyWith<$R, RotationReward, RotationReward>> get b;
  ListCopyWith<$R, RotationReward,
      RotationRewardCopyWith<$R, RotationReward, RotationReward>> get c;
  $R call(
...
class _RotationsCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<$R, RotationReward,
      ...
      get a => ListCopyWith(
          $value.a, (v, t) => v.copyWith.$chain(t), (v) => call(a: v));
  @override
  ListCopyWith<$R, RotationReward,
          RotationRewardCopyWith<$R, RotationReward, RotationReward>>
      get b => ListCopyWith(
          $value.b, (v, t) => v.copyWith.$chain(t), (v) => call(b: v));
  @override
  ListCopyWith<$R, RotationReward,
          RotationRewardCopyWith<$R, RotationReward, RotationReward>>
      get c => ListCopyWith(
          $value.c, (v, t) => v.copyWith.$chain(t), (v) => call(c: v));
  @override
  $R call(
          {List<RotationReward>? a,
          List<RotationReward>? b,
...
class RotationRewardMapper extends ClassMapperBase<RotationReward> {
  ...
  static const Field<RotationReward, String> _f$rarity =
      Field('rarity', _$rarity);
  static double? _$chance(RotationReward v) => v.chance;
  static const Field<RotationReward, double> _f$chance =
...
mixin RotationRewardMappable {
  String toJson() {
    return RotationRewardMapper.ensureInitialized()
        .encodeJson<RotationReward>(this as RotationReward);
  }

  Map<String, dynamic> toMap() {
    return RotationRewardMapper.ensureInitialized()
        .encodeMap<RotationReward>(this as RotationReward);
  }

  RotationRewardCopyWith<RotationReward, RotationReward, RotationReward>
      get copyWith =>
          _RotationRewardCopyWithImpl<RotationReward, RotationReward>(
              this as RotationReward, $identity, $identity);
  @override
  String toString() {
    return RotationRewardMapper.ensureInitialized()
        .stringifyValue(this as RotationReward);
  }

  @override
  bool operator ==(Object other) {
    return RotationRewardMapper.ensureInitialized()
        .equalsValue(this as RotationReward, other);
  }

  @override
  int get hashCode {
    return RotationRewardMapper.ensureInitialized()
        .hashValue(this as RotationReward);
  }
}
