...
/// Strings: 12292
///
/// Built on 2025-10-20 at 13:01 UTC
...
class LocaleSettings extends BaseLocaleSettings<WorldstateLocale, WorldstateData> {
	...
	static Future<WorldstateLocale> setLocale(WorldstateLocale locale, {bool? listenToDeviceLocale = false}) => instance.setLocale(locale, listenToDeviceLocale: listenToDeviceLocale);
	static Future<WorldstateLocale> setLocaleRaw(String rawLocale, {bool? listenToDeviceLocale = false}) => instance.setLocaleRaw(rawLocale, listenToDeviceLocale: listenToDeviceLocale);
	static Future<void> setPluralResolver({String? language, WorldstateLocale? locale, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver}) => instance.setPluralResolver(
		language: language,
		locale: locale,
		cardinalResolver: cardinalResolver,
		ordinalResolver: ordinalResolver,
	...
	static WorldstateLocale setLocaleSync(WorldstateLocale locale, {bool? listenToDeviceLocale = false}) => instance.setLocaleSync(locale, listenToDeviceLocale: listenToDeviceLocale);
	static WorldstateLocale setLocaleRawSync(String rawLocale, {bool? listenToDeviceLocale = false}) => instance.setLocaleRawSync(rawLocale, listenToDeviceLocale: listenToDeviceLocale);
	static void setPluralResolverSync({String? language, WorldstateLocale? locale, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver}) => instance.setPluralResolverSync(
		language: language,
		locale: locale,
		cardinalResolver: cardinalResolver,
		ordinalResolver: ordinalResolver,
...
class AppLocaleUtils extends BaseAppLocaleUtils<WorldstateLocale, WorldstateData> {
	AppLocaleUtils._() : super(
		baseLocale: WorldstateLocale.en,
		locales: WorldstateLocale.values,
	);
	...
	static WorldstateLocale parseLocaleParts({required String languageCode, String? scriptCode, String? countryCode}) => instance.parseLocaleParts(languageCode: languageCode, scriptCode: scriptCode, countryCode: countryCode);
